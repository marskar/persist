...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"persist","description":"Automate creation of figures, models, and plots with GNU Make."}'
	test -f README.rst || echo "persist" >> README.rst
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/marskar/persist.git
